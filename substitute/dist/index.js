...
var concatMap = __nccwpck_require__(585);
var balanced = __nccwpck_require__(513);
...
var expand = __nccwpck_require__(891)
...
async function main() {
    await (0, run_1.run)({
        ...
        variables: (0, run_1.parseVariables)(core.getMultilineInput('variables', { required: true })),
    });
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.PathVariablesPattern = void 0;
class PathVariablesPattern {
    constructor(s) {
...
exports.PathVariablesPattern = PathVariablesPattern;
const compilePathVariablesPatternToRegexp = (s) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.run = exports.parseVariables = void 0;
const fs_1 = __nccwpck_require__(147);
const core = __importStar(__nccwpck_require__(316));
const glob = __importStar(__nccwpck_require__(480));
const match = __importStar(__nccwpck_require__(257));
...
const run = async (inputs) => {
    ...
    for await (const f of files.globGenerator()) {
        core.info(`reading ${f}`);
        const inputManifest = (await fs_1.promises.readFile(f)).toString();
        ...
        await fs_1.promises.writeFile(f, outputManifest, { encoding: 'utf-8' });
    }
};
exports.run = run;
const replace = (s, variables) => {
    let result = s;
...
const internal_globber_1 = __nccwpck_require__(736);
const internal_hash_files_1 = __nccwpck_require__(921);
/**
...
const core = __importStar(__nccwpck_require__(320));
/**
...
const core = __importStar(__nccwpck_require__(320));
const fs = __importStar(__nccwpck_require__(147));
const globOptionsHelper = __importStar(__nccwpck_require__(238));
const path = __importStar(__nccwpck_require__(17));
const patternHelper = __importStar(__nccwpck_require__(322));
const internal_match_kind_1 = __nccwpck_require__(502);
const internal_pattern_1 = __nccwpck_require__(457);
const internal_search_state_1 = __nccwpck_require__(547);
...
exports.Path = void 0;
const path = __importStar(__nccwpck_require__(17));
const pathHelper = __importStar(__nccwpck_require__(358));
const assert_1 = __importDefault(__nccwpck_require__(491));
const IS_WINDOWS = process.platform === 'win32';
/**
...
const pathHelper = __importStar(__nccwpck_require__(358));
const assert_1 = __importDefault(__nccwpck_require__(491));
const minimatch_1 = __nccwpck_require__(615);
const internal_match_kind_1 = __nccwpck_require__(502);
const internal_path_1 = __nccwpck_require__(523);
const IS_WINDOWS = process.platform === 'win32';
class Pattern {
...
const command_1 = __nccwpck_require__(489);
