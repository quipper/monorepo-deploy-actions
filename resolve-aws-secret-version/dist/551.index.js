...
var tokenProviders = __webpack_require__(6480);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(7446); });
    const sso = ssoClient ||
...
var sso = __webpack_require__(5191);
...
var client$1 = __webpack_require__(7416);
var core = __webpack_require__(647);
var client = __webpack_require__(3471);
var config = __webpack_require__(1182);
var endpoints = __webpack_require__(8822);
var protocols = __webpack_require__(3505);
var retry = __webpack_require__(9210);
var schema = __webpack_require__(4403);
var httpAuthSchemes = __webpack_require__(795);
var serde = __webpack_require__(6129);
var nodeHttpHandler = __webpack_require__(7135);
var protocols$1 = __webpack_require__(9792);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 671).then(__webpack_require__.t.bind(__webpack_require__, 5671, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 671).then(__webpack_require__.t.bind(__webpack_require__, 5671, 19));
