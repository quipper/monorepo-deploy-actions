...
var config = __webpack_require__(8208);
var client = __webpack_require__(2596);
var credentialProviderLogin = __webpack_require__(8215);

const resolveCredentialSource = (credentialSource, profileName, logger) => {
    const sourceProvidersMap = {
        EcsContainer: async (options) => {
            const { fromHttp } = await __webpack_require__.e(/* import() */ 200).then(__webpack_require__.t.bind(__webpack_require__, 6200, 19));
            const { fromContainerMetadata } = await __webpack_require__.e(/* import() */ 723).then(__webpack_require__.t.bind(__webpack_require__, 2723, 19));
        ...
        Ec2InstanceMetadata: async (options) => {
            ...
            const { fromInstanceMetadata } = await __webpack_require__.e(/* import() */ 723).then(__webpack_require__.t.bind(__webpack_require__, 2723, 19));
            return async () => fromInstanceMetadata(options)().then(setNamedProvider);
        },
        Environment: async (options) => {
            logger?.debug("@aws-sdk/credential-provider-ini - credential_source is Environment");
            const { fromEnv } = await Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 4404, 19));
...
const resolveAssumeRoleCredentials = async (profileName, profiles, options, callerClientConfig, visitedProfiles = {}, resolveProfileData) => {
    ...
    if (!options.roleAssumer) {
        const { getDefaultRoleAssumer } = await __webpack_require__.e(/* import() */ 749).then(__webpack_require__.t.bind(__webpack_require__, 1749, 19));
...
const resolveProcessCredentials = async (options, profile) => __webpack_require__.e(/* import() */ 908).then(__webpack_require__.t.bind(__webpack_require__, 4908, 19)).then(({ fromProcess }) => fromProcess({
    ...options,
    profile,
...
const resolveSsoCredentials = async (profile, profileData, options = {}, callerClientConfig) => {
    const { fromSSO } = await __webpack_require__.e(/* import() */ 195).then(__webpack_require__.t.bind(__webpack_require__, 7195, 19));
    return fromSSO({
        profile,
...
const isWebIdentityProfile = (arg) => Boolean(arg) &&
    ...
    typeof arg.role_arn === "string" &&
    ["undefined", "string"].indexOf(typeof arg.role_session_name) > -1;
const resolveWebIdentityCredentials = async (profile, options, callerClientConfig) => __webpack_require__.e(/* import() */ 211).then(__webpack_require__.t.bind(__webpack_require__, 1211, 23)).then(({ fromTokenFile }) => fromTokenFile({
...
var client = __webpack_require__(2596);
var config = __webpack_require__(8208);
var protocols = __webpack_require__(6051);
...
class LoginCredentialsFetcher {
    ...
    async refresh(token) {
        const { SigninClient, CreateOAuth2TokenCommand } = await __webpack_require__.e(/* import() */ 846).then(__webpack_require__.t.bind(__webpack_require__, 9465, 19));
