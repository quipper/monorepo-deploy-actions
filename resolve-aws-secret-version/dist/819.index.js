...
const client_1 = __webpack_require__(7411);
const config_1 = __webpack_require__(6245);
const node_fs_1 = __webpack_require__(3024);
const fromWebToken_1 = __webpack_require__(7904);
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await __webpack_require__.e(/* import() */ 344).then(__webpack_require__.t.bind(__webpack_require__, 344, 19));
...
var fromTokenFile = __webpack_require__(2704);
var fromWebToken = __webpack_require__(7904);
