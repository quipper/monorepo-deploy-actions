...
const ruleset_1 = __webpack_require__(4542);
...
var middlewareUserAgent = __webpack_require__(6915);
...
var httpAuthSchemeProvider = __webpack_require__(3795);
var runtimeConfig = __webpack_require__(8858);
var regionConfigResolver = __webpack_require__(8151);
var protocolHttp = __webpack_require__(9953);
var schemas_0 = __webpack_require__(2700);
var errors = __webpack_require__(400);
var SSOServiceException = __webpack_require__(4064);
...
const SSOServiceException_1 = __webpack_require__(4064);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(3483));
const core_1 = __webpack_require__(3548);
...
const runtimeConfig_shared_1 = __webpack_require__(819);
...
const httpAuthSchemeProvider_1 = __webpack_require__(3795);
const endpointResolver_1 = __webpack_require__(8845);
const schemas_0_1 = __webpack_require__(2700);
const getRuntimeConfig = (config) => {
    return {
...
const errors_1 = __webpack_require__(400);
const SSOServiceException_1 = __webpack_require__(4064);
...
var client = __webpack_require__(8996);
var tokenProviders = __webpack_require__(6246);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(4913); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(8200);
...
var client = __webpack_require__(8996);
var httpAuthSchemes = __webpack_require__(8551);
var propertyProvider = __webpack_require__(5169);
var sharedIniFileLoader = __webpack_require__(1247);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 38).then(__webpack_require__.t.bind(__webpack_require__, 2038, 23));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 38).then(__webpack_require__.t.bind(__webpack_require__, 2038, 23));
