...
var tokenProviders = __webpack_require__(9387);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(4509); });
    const sso = ssoClient ||
...
var sso = __webpack_require__(1185);
...
const httpAuthSchemes_1 = __webpack_require__(8803);
...
const ruleset_1 = __webpack_require__(6809);
...
var httpAuthSchemeProvider = __webpack_require__(5338);
var runtimeConfig = __webpack_require__(3115);
var regionConfigResolver = __webpack_require__(2585);
var protocolHttp = __webpack_require__(9228);
var schemas_0 = __webpack_require__(3721);
var errors = __webpack_require__(1069);
var SSOServiceException = __webpack_require__(6859);
...
const SSOServiceException_1 = __webpack_require__(6859);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(5368));
...
const runtimeConfig_shared_1 = __webpack_require__(5560);
...
const httpAuthSchemeProvider_1 = __webpack_require__(5338);
const endpointResolver_1 = __webpack_require__(6884);
const schemas_0_1 = __webpack_require__(3721);
const getRuntimeConfig = (config) => {
    return {
...
const errors_1 = __webpack_require__(1069);
const SSOServiceException_1 = __webpack_require__(6859);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 765).then(__webpack_require__.t.bind(__webpack_require__, 6765, 23));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 765).then(__webpack_require__.t.bind(__webpack_require__, 6765, 23));
