...
var tokenProviders = __webpack_require__(2308);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(834); });
    const sso = ssoClient ||
...
var sso = __webpack_require__(3435);
...
var client$1 = __webpack_require__(7411);
...
var httpAuthSchemes = __webpack_require__(8158);
var serde = __webpack_require__(4640);
var nodeHttpHandler = __webpack_require__(9169);
var protocols$1 = __webpack_require__(2901);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 91).then(__webpack_require__.t.bind(__webpack_require__, 6091, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 91).then(__webpack_require__.t.bind(__webpack_require__, 6091, 19));
