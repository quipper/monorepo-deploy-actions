...
const fromWebToken_1 = __webpack_require__(5267);
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await Promise.resolve().then(() => __importStar(__webpack_require__(6320)));
...
var fromTokenFile = __webpack_require__(813);
var fromWebToken = __webpack_require__(5267);
