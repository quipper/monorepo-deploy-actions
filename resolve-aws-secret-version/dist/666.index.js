...
var config = __webpack_require__(1182);
var client = __webpack_require__(7416);
var credentialProviderLogin = __webpack_require__(8739);

const resolveCredentialSource = (credentialSource, profileName, logger) => {
    const sourceProvidersMap = {
        EcsContainer: async (options) => {
            const { fromHttp } = await __webpack_require__.e(/* import() */ 641).then(__webpack_require__.t.bind(__webpack_require__, 9641, 19));
            const { fromContainerMetadata } = await __webpack_require__.e(/* import() */ 354).then(__webpack_require__.t.bind(__webpack_require__, 354, 19));
        ...
        Ec2InstanceMetadata: async (options) => {
            ...
            const { fromInstanceMetadata } = await __webpack_require__.e(/* import() */ 354).then(__webpack_require__.t.bind(__webpack_require__, 354, 19));
            return async () => fromInstanceMetadata(options)().then(setNamedProvider);
        },
        Environment: async (options) => {
            logger?.debug("@aws-sdk/credential-provider-ini - credential_source is Environment");
            const { fromEnv } = await Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 9419, 19));
...
const resolveAssumeRoleCredentials = async (profileName, profiles, options, callerClientConfig, visitedProfiles = {}, resolveProfileData) => {
    ...
    if (!options.roleAssumer) {
        const { getDefaultRoleAssumer } = await __webpack_require__.e(/* import() */ 228).then(__webpack_require__.t.bind(__webpack_require__, 8228, 19));
...
const resolveProcessCredentials = async (options, profile) => __webpack_require__.e(/* import() */ 751).then(__webpack_require__.t.bind(__webpack_require__, 8751, 19)).then(({ fromProcess }) => fromProcess({
    ...options,
    profile,
...
const resolveSsoCredentials = async (profile, profileData, options = {}, callerClientConfig) => {
    const { fromSSO } = await __webpack_require__.e(/* import() */ 551).then(__webpack_require__.t.bind(__webpack_require__, 4551, 19));
    return fromSSO({
        profile,
...
const isWebIdentityProfile = (arg) => Boolean(arg) &&
    ...
    typeof arg.role_arn === "string" &&
    ["undefined", "string"].indexOf(typeof arg.role_session_name) > -1;
const resolveWebIdentityCredentials = async (profile, options, callerClientConfig) => __webpack_require__.e(/* import() */ 839).then(__webpack_require__.t.bind(__webpack_require__, 9839, 23)).then(({ fromTokenFile }) => fromTokenFile({
...
var client = __webpack_require__(7416);
var config = __webpack_require__(1182);
var protocols = __webpack_require__(3505);
...
class LoginCredentialsFetcher {
    ...
    async refresh(token) {
        const { SigninClient, CreateOAuth2TokenCommand } = await __webpack_require__.e(/* import() */ 846).then(__webpack_require__.t.bind(__webpack_require__, 8846, 19));
