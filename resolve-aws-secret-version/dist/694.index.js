...
var client = __webpack_require__(9757);
var tokenProviders = __webpack_require__(7453);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(6970); });
    const sso = ssoClient ||
...
var sso = __webpack_require__(4547);
...
const httpAuthSchemes_1 = __webpack_require__(8832);
...
const ruleset_1 = __webpack_require__(8715);
...
var middlewareUserAgent = __webpack_require__(8232);
...
var httpAuthSchemeProvider = __webpack_require__(9916);
var runtimeConfig = __webpack_require__(6581);
var regionConfigResolver = __webpack_require__(6099);
var protocolHttp = __webpack_require__(9526);
var schemas_0 = __webpack_require__(2215);
var errors = __webpack_require__(2851);
var SSOServiceException = __webpack_require__(2121);
...
const SSOServiceException_1 = __webpack_require__(2121);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(986));
const client_1 = __webpack_require__(9757);
const httpAuthSchemes_1 = __webpack_require__(8832);
const util_user_agent_node_1 = __webpack_require__(6381);
...
const runtimeConfig_shared_1 = __webpack_require__(634);
...
exports.getRuntimeConfig = void 0;
const httpAuthSchemes_1 = __webpack_require__(8832);
const protocols_1 = __webpack_require__(6835);
...
const httpAuthSchemeProvider_1 = __webpack_require__(9916);
const endpointResolver_1 = __webpack_require__(1938);
const schemas_0_1 = __webpack_require__(2215);
const getRuntimeConfig = (config) => {
    return {
...
const errors_1 = __webpack_require__(2851);
const SSOServiceException_1 = __webpack_require__(2121);
...
var client = __webpack_require__(9757);
var httpAuthSchemes = __webpack_require__(8832);
var propertyProvider = __webpack_require__(7930);
var sharedIniFileLoader = __webpack_require__(9498);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 195).then(__webpack_require__.t.bind(__webpack_require__, 6195, 23));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 195).then(__webpack_require__.t.bind(__webpack_require__, 6195, 23));
