...
var client = __webpack_require__(846);
var credentialProviderLogin = __webpack_require__(4610);

const resolveCredentialSource = (credentialSource, profileName, logger) => {
    const sourceProvidersMap = {
        EcsContainer: async (options) => {
            const { fromHttp } = await __webpack_require__.e(/* import() */ 427).then(__webpack_require__.t.bind(__webpack_require__, 427, 19));
            const { fromContainerMetadata } = await __webpack_require__.e(/* import() */ 712).then(__webpack_require__.t.bind(__webpack_require__, 8712, 19));
        ...
        Ec2InstanceMetadata: async (options) => {
            ...
            const { fromInstanceMetadata } = await __webpack_require__.e(/* import() */ 712).then(__webpack_require__.t.bind(__webpack_require__, 8712, 19));
            return async () => fromInstanceMetadata(options)().then(setNamedProvider);
        },
        Environment: async (options) => {
            logger?.debug("@aws-sdk/credential-provider-ini - credential_source is Environment");
            const { fromEnv } = await Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 4938, 19));
...
const resolveAssumeRoleCredentials = async (profileName, profiles, options, callerClientConfig, visitedProfiles = {}, resolveProfileData) => {
    ...
    if (!options.roleAssumer) {
        const { getDefaultRoleAssumer } = await __webpack_require__.e(/* import() */ 354).then(__webpack_require__.t.bind(__webpack_require__, 8354, 19));
...
const resolveProcessCredentials = async (options, profile) => __webpack_require__.e(/* import() */ 82).then(__webpack_require__.t.bind(__webpack_require__, 6082, 19)).then(({ fromProcess }) => fromProcess({
    ...options,
    profile,
...
const resolveSsoCredentials = async (profile, profileData, options = {}, callerClientConfig) => {
    const { fromSSO } = await __webpack_require__.e(/* import() */ 189).then(__webpack_require__.t.bind(__webpack_require__, 4189, 19));
    return fromSSO({
        profile,
...
const isWebIdentityProfile = (arg) => Boolean(arg) &&
    ...
    typeof arg.role_arn === "string" &&
    ["undefined", "string"].indexOf(typeof arg.role_session_name) > -1;
const resolveWebIdentityCredentials = async (profile, options, callerClientConfig) => __webpack_require__.e(/* import() */ 593).then(__webpack_require__.t.bind(__webpack_require__, 7593, 23)).then(({ fromTokenFile }) => fromTokenFile({
...
class LoginCredentialsFetcher {
    ...
    async refresh(token) {
        const { SigninClient, CreateOAuth2TokenCommand } = await __webpack_require__.e(/* import() */ 48).then(__webpack_require__.t.bind(__webpack_require__, 3048, 19));
