...
const shared_ini_file_loader_1 = __webpack_require__(3083);
const node_fs_1 = __webpack_require__(3024);
const fromWebToken_1 = __webpack_require__(9945);
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await Promise.resolve().then(() => __importStar(__webpack_require__(5881)));
...
var fromTokenFile = __webpack_require__(2542);
var fromWebToken = __webpack_require__(9945);
