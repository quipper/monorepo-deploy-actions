...
const fromWebToken_1 = __webpack_require__(2865);
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await Promise.resolve().then(() => __importStar(__webpack_require__(3266)));
...
var fromTokenFile = __webpack_require__(6923);
var fromWebToken = __webpack_require__(2865);
...
//# sourceMappingURL=528.index.js.map