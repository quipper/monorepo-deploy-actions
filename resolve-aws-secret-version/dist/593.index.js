...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await __webpack_require__.e(/* import() */ 354).then(__webpack_require__.t.bind(__webpack_require__, 8354, 19));
...
var fromTokenFile = __webpack_require__(4782);
