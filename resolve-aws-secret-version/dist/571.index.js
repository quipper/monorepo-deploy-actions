...
var client = __webpack_require__(7078);
var tokenProviders = __webpack_require__(222);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(4042); });
    const sso = ssoClient ||
...
var sso = __webpack_require__(3404);
...
const ruleset_1 = __webpack_require__(8565);
...
var httpAuthSchemeProvider = __webpack_require__(2335);
var runtimeConfig = __webpack_require__(2670);
var regionConfigResolver = __webpack_require__(9285);
var protocolHttp = __webpack_require__(9228);
var schemas_0 = __webpack_require__(6968);
var errors = __webpack_require__(5420);
var SSOServiceException = __webpack_require__(4412);
...
const SSOServiceException_1 = __webpack_require__(4412);
...
const runtimeConfig_shared_1 = __webpack_require__(39);
...
const httpAuthSchemeProvider_1 = __webpack_require__(2335);
const endpointResolver_1 = __webpack_require__(9881);
const schemas_0_1 = __webpack_require__(6968);
const getRuntimeConfig = (config) => {
    return {
...
const errors_1 = __webpack_require__(5420);
const SSOServiceException_1 = __webpack_require__(4412);
...
var client = __webpack_require__(7078);
var httpAuthSchemes = __webpack_require__(2097);
var propertyProvider = __webpack_require__(4036);
var sharedIniFileLoader = __webpack_require__(7016);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 578).then(__webpack_require__.t.bind(__webpack_require__, 8578, 23));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 578).then(__webpack_require__.t.bind(__webpack_require__, 8578, 23));
