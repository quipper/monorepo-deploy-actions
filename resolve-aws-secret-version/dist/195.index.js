...
var tokenProviders = __webpack_require__(6713);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(794); });
    const sso = ssoClient ||
...
var sso = __webpack_require__(3382);
...
var client$1 = __webpack_require__(2596);
var core = __webpack_require__(9741);
var client = __webpack_require__(6045);
var config = __webpack_require__(8208);
var endpoints = __webpack_require__(7072);
var protocols = __webpack_require__(6051);
var retry = __webpack_require__(4684);
var schema = __webpack_require__(7393);
var httpAuthSchemes = __webpack_require__(3479);
var serde = __webpack_require__(7643);
var nodeHttpHandler = __webpack_require__(3485);
var protocols$1 = __webpack_require__(828);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 832).then(__webpack_require__.t.bind(__webpack_require__, 7832, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 832).then(__webpack_require__.t.bind(__webpack_require__, 7832, 19));
